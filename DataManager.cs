...
public class DataManager : Singleton<DataManager>
{
    ...
    public void Load()
    {
        ...
        this.Teleporters = JsonConvert.DeserializeObject<Dictionary<int, TeleporterDefine>>(json);//读取地图中传送点的位置
        ...
        this.ShopItems = JsonConvert.DeserializeObject<Dictionary<int, Dictionary<int, ShopItemDefine>>>(json);//双key
